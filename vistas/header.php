        ...
        <div class = "wrapper">
            ...
            <header class = "main-header">
                ...
                <a href = "index2.html" class = "logo">
                    ...
                    <span class = "logo-lg"><b>MI IPS</b></span>
                </a>
                                ...
                                <ul class = "dropdown-menu">
                                    ...
                                    <li class = "user-footer">
                                        ...
                                        <div class = "pull-right">
                                            <a href = "../controlador/usuario.php?op=salir" class = "btn btn-default btn-flat">Cerrar</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <ul class = "sidebar-menu">
                        ...
                        <li>
                            <a href = "#">
                                ...
                                <small class = "label pull-right bg-yellow">MI</small>
                            </a>
                        </li>
